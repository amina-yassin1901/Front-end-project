...
//   const filterType = filterBlock.dataset.type;
//   const list = filterBlock.querySelector(".filter-list");

//   const filterData = filters.find(function (filter) {
//     return filter.type === filterType;
//   });

//   filterData.options.forEach(function (option) {
//     const li = document.createElement("li");
...
//     const filterBlock = list.parentElement;
//     const filterType = filterBlock.dataset.type;
//     const value = clickedItem.dataset.value;

//     selectedFilters[filterType] = value;

//     filterBlock.querySelector(".filter-btn").innerHTML =
//       clickedItem.textContent +
//       ` <svg width="14" height="14">
//           <use href="assets/icons/sprite.svg#down"></use>
//         </svg>`;
...
//       return event.date.getTime() === Number(selectedFilters.day);
//     });
//   }

//   if (selectedFilters.type !== "Any type") {
//     result = result.filter(function (event) {
//       return event.type === selectedFilters.type;
//     });
//   }

//   if (selectedFilters.distance !== "Any distance") {
//     result = result.filter(function (event) {
//       return event.distance <= Number(selectedFilters.distance);
//     });
//   }

//   if (selectedFilters.category !== "Any category") {
//     result = result.filter(function (event) {
//       return event.category === selectedFilters.category;
//     });
//   }
